...
public class DateRecognizer {
	/**
	 * <p> Title: FSM-translated DateRecognizer. </p>
	 * 
	...
	public static String dateRecognizerErrorMessage = "";		// The error message text
	public static String dateRecognizerInput = "";				// The input being processed
	public static int dateRecognizerIndexofError = -1;			// The index where the error was located
